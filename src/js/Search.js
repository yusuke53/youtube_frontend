                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group col-xs-offset-0 col-xs-12 col-md-offset-2 col-md-8">
                                ...
                                <div className="sample">
                                    <input type="radio" name="s1" id="select1" value="1" checked={this.state.radio === 'a'} onChange={() => this.setState({radio: 'a', category:'10', index:0})}/>
                                    <label htmlFor="select1">Music</label>
                                    <input type="radio" name="s2" id="select2" value="2" checked={this.state.radio === 'b'} onChange={() => this.setState({radio: 'b', category:'23', index:1})}/>
                                    <label htmlFor="select2">Comedy</label>
                                    <input type="radio" name="s3" id="select3" value="3" checked={this.state.radio === 'c'} onChange={() => this.setState({radio: 'c', category:'24', index:2})}/>
                                    <label htmlFor="select3">Entertainment</label>
                                    <input type="radio" name="s4" id="select4" value="4" checked={this.state.radio === 'd'} onChange={() => this.setState({radio: 'd', category:'25', index:3})}/>
                                    <label htmlFor="select4">News</label>
                                    <input type="radio" name="s5" id="select5" value="5" checked={this.state.radio === 'e'} onChange={() => this.setState({radio: 'e', category:'28', index:4})}/>
